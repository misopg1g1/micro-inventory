...
describe('InventoryService', () => {
  ...
  beforeEach(async () => {
    ...
    repository = module.get<Repository<InventoryEntity>>(getRepositoryToken(InventoryEntity));
    await seedDatabase();
  });
  ...
  it('findOne should return a inventory by product_id', async () => {
    ...
    const inventory: InventoryEntity = await service.findOne(storedInventory.product_id);
  ...
  it('create should return a new inventory', async () => {
    ...
    const storedInventory: InventoryEntity = await repository.findOne({where:{product_id: newInventory.product_id}})
  ...
  it('update should modify an existing inventory', async () => {
    ...
    const updatedInventory: InventoryEntity = await service.update(inventory.product_id,inventory);
